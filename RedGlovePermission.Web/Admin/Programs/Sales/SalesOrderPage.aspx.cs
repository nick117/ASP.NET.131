...
namespace RedGlovePermission.Web.Admin.Programs.Sales
{
    public partial class SalesOrderPage : System.Web.UI.Page
    {
        ...
        RedGlovePermission.BLL.Sales_Order bllOrder = new RedGlovePermission.BLL.Sales_Order();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //初始化模組權限
                UserHandle.InitModule("Mod_SalesOrder");
        ...
        {
            string strOrderID = (string)e.Keys[0];
            ...
            SqlCommand command = new SqlCommand("select * from Sales_Order_DTL where OrderID = '" + strOrderID +"'", connection);
            try
            {
                connection.Open();
            ...
            dsMaster.DeleteParameters["OrderID"].DefaultValue = strOrderID.ToString();
            dsMaster.Delete();
        ...
        protected void gvMaster_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string strOrderID = (string)e.Keys[0];
            dsMaster.UpdateParameters["OrderID"].DefaultValue = strOrderID.ToString();
        ...
        protected void gvChild_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            dsChild.DeleteParameters["OrderID"].DefaultValue = gvr.Cells[5].Text;
            dsChild.DeleteParameters["SEQM"].DefaultValue = ((GridView)sender).Rows[e.RowIndex].Cells[1].Text;
            dsChild.Delete();
            //處理單頭合計及稅額
            if (bllOrder.OrderTotal(gvr.Cells[5].Text) == 0)
            ...
            {
                RedGlovePermission.Model.Sales_Order ordermodel = new RedGlovePermission.Model.Sales_Order();
                ordermodel = bllOrder.GetOrderModel(gvr.Cells[5].Text);
                gvr.Cells[13].Text = ordermodel.Amount.ToString();
                gvr.Cells[14].Text = ordermodel.Tax.ToString();
            }
            ScriptManager.RegisterStartupScript(Page, GetType(), Guid.NewGuid().ToString(), "alert('" + ResourceManager.GetString("Pub_Msg_delete_true") + "');", true);
        }
        ...
        protected void gvChild_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            dsChild.UpdateParameters["OrderID"].DefaultValue = gvr.Cells[5].Text;
        ...
        protected void gvMaster_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "InsertNewM")
            {
                ...
                TextBox tbOrder_Date = (TextBox)gvMaster.Controls[0].Controls[0].FindControl("tbOrder_Date");
                ...
                TextBox tbAddress = (TextBox)gvMaster.Controls[0].Controls[0].FindControl("tbAddress");
                ...
                dsMaster.InsertParameters["OrderID"].DefaultValue = bllOrder.GetNewOrderID(model.Track + DateTime.Now.ToString("yyyyMMdd"));
                if (tbMA001 != null)
                ...
                if (tbOrder_Date != null)
                    dsMaster.InsertParameters["ORDER_DATE"].DefaultValue = tbOrder_Date.Text;
                if (tbCaseNo != null)
                ...
                if (tbAddress != null)
                    dsMaster.InsertParameters["Address"].DefaultValue = tbAddress.Text;
                if (tbRemark != null)
                ...
                //    _hfSearch.Value = "";
                //}
                    _hfSearch.Value = "OrderID='" + dsMaster.InsertParameters["OrderID"].DefaultValue.ToString() + "'";
                BindData();
            }
        ...
        protected void gvChild_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "InsertNew")
            {
                ...
                TextBox tbFreeQty = (TextBox)((GridView)sender).Controls[0].Controls[0].FindControl("tbFreeQty");
                ...
                RedGlovePermission.Model.Basic_Companies model = new RedGlovePermission.Model.Basic_Companies();
                model = bll.GetCCompanyModel(CompanyList.SelectedItem.ToString());
                dsChild.InsertParameters["Seq"].DefaultValue = bllOrder.GetNewOrderSeq(gvr.Cells[5].Text);
                if (tbMB001 != null)
                    dsChild.InsertParameters["MB001"].DefaultValue = tbMB001.Text;
                if (tbFreeQty != null)
                    dsChild.InsertParameters["FreeQty"].DefaultValue = tbFreeQty.Text;
                if (tbQty != null)
                ...
                dsChild.InsertParameters["OrderId"].DefaultValue = gvr.Cells[5].Text;
                UserSession user = SessionBox.GetUserSession();
