...
<tr><td width="20%"><%=ResourceManager.GetString("SalesOrderPage_Lab_1_5")%></td><td><asp:TextBox ID="tbFreeQty" runat="server" Height="21px" MaxLength="20" Width="98%"></asp:TextBox></td><td></td></tr>
                    ...
                    <table style="width:50%;">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                onclick="window.open('../../Tools/Calendar.aspx?TextBoxId=CtbOrder_Date', '','height=315,width=350,status=no,toolbar=no,menubar=no,location=no', '');"
                                    Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
