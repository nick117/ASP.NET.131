...
{
    public partial class CodePage : CommonPage
    {
        RedGlovePermission.BLL.Basic_System bll = new RedGlovePermission.BLL.Basic_System();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //初始化模組權限
                UserHandle.InitModule("Mod_Code");
        ...
        {
            DataSet ds = bll.GetCodeList("", "order by Code asc");
        ...
        {
            DataSet ds = bll.GetCodeList("Code like '%" + txt_Code.Text.Trim() + "%' and Items like '%" + txt_Items.Text.Trim() + "%'", "order by Code asc");
        ...
        /// 分頁
        /// </summary>
        protected void CodeLists_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            CodeLists.PageIndex = e.NewPageIndex;
        ...
        /// 退出編輯狀態
        /// </summary>
        protected void CodeLists_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
        ...
        /// 執行事件（删除操作）
        /// </summary>
        protected void CodeLists_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.ToString() == "Del")
            {
                int ret = bll.DeleteCode(e.CommandArgument.ToString());
                switch (ret)
                {
                    case 1:
                        BindOrder();
        ...
        /// 變更到編輯狀態
        /// </summary>
        protected void CodeLists_RowEditing(object sender, GridViewEditEventArgs e)
        {
            CodeLists.EditIndex = e.NewEditIndex;
            BindOrder2();
        }
        ...
        /// 資料綁定到表格
        /// </summary>
        protected void CodeLists_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void CodeLists_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                #region 語言
                tcHeader[0].Text = ResourceManager.GetString("CodePage_Lab_0");
                tcHeader[1].Text = ResourceManager.GetString("CodePage_Lab_1");
                tcHeader[2].Text = ResourceManager.GetString("Pub_Lbtn_update");
                tcHeader[3].Text = ResourceManager.GetString("Pub_Lbtn_delete");
                #endregion
            }
        }
    }
