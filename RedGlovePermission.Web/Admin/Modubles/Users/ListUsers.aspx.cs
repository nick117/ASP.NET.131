...
namespace RedGlovePermission.Web.Admin.Modubles.Users
{
    public partial class ListUsers : CommonPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //初始化模块权限
                UserHandle.InitModule("Mod_Member");
        ...
        protected void UserList_RowCreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                tcHeader[7].Text = ResourceManager.GetString("ListUsers_Lab_7");
                tcHeader[8].Text = ResourceManager.GetString("Pub_Lbtn_update");
                tcHeader[9].Text = ResourceManager.GetString("Pub_Lbtn_delete");
                #endregion
            }
        }
    }
