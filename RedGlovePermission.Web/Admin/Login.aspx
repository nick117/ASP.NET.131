                    ...
                    <table width="377" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="padding-left: 20px; padding-top: 20px;">
                                ...
                                <span style="font-family: MS Reference Sans Serif; font-weight: bold; color: #fff;" 
                                    class="style4">Powered by</span><span style="font-family: MS Reference Sans Serif; font-weight: bold; font-size: 32px;
                                    color: #fff;"><br />
                                </span>
                                <span style="font-family: MS Reference Sans Serif; font-weight: bold; color: #fff;" 
                                    class="style5">RedGlove</span><br class="style5" />
                                <span style="font-family: MS Reference Sans Serif; color: #fff;" class="style5">Management
                                    system</span>
                            </td>
                        </tr>
                    </table>
