    ...
    <asp:UpdatePanel ID="CustomPanel1" runat="server">
        <ContentTemplate>
            <div id="title" class="childtoolbar">
                ...
                <div class="rowdiv">
                    <asp:TextBox ID="txt_MA001" Width="120" MaxLength="30" CssClass="inputbox" runat="server" onclick="window.open('../../Tools/Customers.aspx?TextBoxId=Ctxt_MA001', '','height=550,width=750,status=no,toolbar=no,menubar=no,location=no', '');" ></asp:TextBox></div>
        ...
        function GetCustomer(mySelect) {
            ...
            if (!is_null(table.rows[mySelect].cells[3]))
                if (!is_null(table.rows[mySelect].cells[3].getElementsByTagName("input")[0]))
                    window.open('../../Tools/Customers.aspx?TextBoxId=ACaseLists,3,4,' + mySelect, '', 'height=530,width=750,status=no,toolbar=no,menubar=no,location=no', '');
        }
  </script>
</body>
</html>
