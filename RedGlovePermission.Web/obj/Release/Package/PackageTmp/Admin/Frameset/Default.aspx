    ...
    <div id="topdiv">
        <div class="header">
            ...
            <div class="mainbutton">
                ...
                <div class="text">
                    <a href="Default.aspx" class="mainlink"><%=ResourceManager.GetString("Default_Link_1") %></a></div>
                <div class="ico">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:TreeView ID="MenuTreeView" runat="server" ImageSet="Msdn" NodeIndent="10">
                        ...
                        <NodeStyle Font-Names="Verdana" Font-Size="12pt" ForeColor="Black" HorizontalPadding="5px"
