<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderPage.aspx.cs" Inherits="RedGlovePermission.Web.Admin.Programs.Sales.SalesOrderPage" %>
...
<head id="Head1" runat="server">
    <title>
        <%=ResourceManager.GetString("SalesOrderPage_Title_name")%></title>
...
<body>
    ...
    <div id="divToolBar" class="topBar">
        ...
        <div class="moduleName">
            <%=ResourceManager.GetString("SalesOrderPage_Title_name")%></div>
    </div>
    ...
    <div>
        <div id="GridViewMsg" style="padding: 5px;" runat="server">  
            <NestableGridView:NestableGridView ID="gvMaster" runat="server" 
                ...
                CellPadding="4" ChildTableID="pnlChild" DataKeyNames="OrderID" 
                ...
                <SearchFilters><asp:ListItem Value="MA001">客戶</asp:ListItem><asp:ListItem Value="OrderID">單號</asp:ListItem></SearchFilters>
                ...
                <Columns>
                    ...
                    <asp:TemplateField><ItemTemplate><asp:Panel ID="pnlChild" runat="server" Visible="false" Width="100%"><table width="100%"><tr><td><SearchGridView:SearchGridView ID="gvChild" runat="server" AllowPaging="True" 
                                                ...
                                                DataKeyNames="OrderID" DataSourceID="dsChild" GridLines="Horizontal" 
                                                ...
                                                Width="100%"><SearchFilters><asp:ListItem Value="MB001">產品編號</asp:ListItem></SearchFilters><FooterStyle BackColor="#B5C7DE" ForeColor="#4A3C8C" /><RowStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" /><EmptyDataRowStyle BackColor="#F7F6F3" ForeColor="#333333" /><Columns><asp:BoundField DataField="Seq" HeaderText="項次" ReadOnly="True" SortExpression="Seq" /><asp:BoundField DataField="MB001" HeaderText="產品編號" SortExpression="MB001"><ItemStyle HorizontalAlign="Left" /></asp:BoundField><asp:BoundField DataField="MB002" HeaderText="品名" ReadOnly="True" SortExpression="MB002"><ItemStyle HorizontalAlign="Left" /></asp:BoundField><asp:BoundField DataField="MB003" HeaderText="規格" ReadOnly="True" SortExpression="MB003"><ItemStyle HorizontalAlign="Left" /></asp:BoundField><asp:BoundField DataField="MB004" HeaderText="單位" ReadOnly="True" SortExpression="MB004" /><asp:BoundField DataField="FreeQty" HeaderText="贈品" SortExpression="FreeQty" ><ItemStyle HorizontalAlign="Right" /></asp:BoundField><asp:BoundField DataField="Qty" HeaderText="數量" SortExpression="Qty" ><ItemStyle HorizontalAlign="Right" /></asp:BoundField><asp:BoundField DataField="UnitPrice" HeaderText="單價" SortExpression="UnitPrice" ><ItemStyle HorizontalAlign="Right" /></asp:BoundField><asp:BoundField DataField="Discount" DataFormatString="{0:P0}" HeaderText="折扣" SortExpression="Discount" ><ItemStyle HorizontalAlign="Right" /></asp:BoundField><asp:BoundField DataField="Amount" DataFormatString="{0:f2}" HeaderText="金額" ReadOnly="True" SortExpression="Amount" ><ItemStyle HorizontalAlign="Right" /></asp:BoundField><asp:CommandField ButtonType="Image" CancelImageUrl="~/Images/cancel.gif" 
                                                        ...
                                                        HeaderText="刪除" ShowDeleteButton="True" ShowHeader="True"><ItemStyle HorizontalAlign="Center" /></asp:CommandField></Columns><PagerStyle BackColor="#E7E7FF" ForeColor="#4A3C8C" HorizontalAlign="Right" /><EmptyDataTemplate><table style="width:100%;"><tr><td width="20%"></td><td width="70%"><asp:TextBox ID="tbMB001" runat="server" Height="21px" MaxLength="40" 
                                                                    onclick="GetProductNew(this)" Width="98%"></asp:TextBox></td><td width="5%"></td></tr><tr><td width="20%"></td><td><asp:TextBox ID="tbFreeQty" runat="server" Height="21px" MaxLength="20" Width="98%"></asp:TextBox></td><td></td></tr><tr><td width="20%"></td><td><asp:TextBox ID="tbQty" runat="server" Height="21px" MaxLength="20" Width="98%"></asp:TextBox></td><td></td></tr><tr><td width="20%"></td><td><asp:TextBox ID="tbUnitPrice" runat="server" Height="21px" Width="98%"></asp:TextBox></td></tr><tr><td width="20%"></td><td><asp:TextBox ID="tbDiscount" runat="server" Height="21px" Width="98%" >1</asp:TextBox></td><td><asp:ImageButton ID="ImageButton1" runat="server" CommandName="InsertNew" 
                                ...
                                DeleteCommand="delete Sales_Order_DTL where OrderID=@OrderID and Seq=@SEQM" 
                                InsertCommand="INSERT INTO Sales_Order_DTL(OrderID, Seq, MB001, FreeQty, Qty, UnitPrice, Discount, Creator, Create_Date) VALUES (@OrderID, @Seq, @MB001, @FreeQty, @Qty, @UnitPrice, @Discount, @Creator, @Create_Date)" 
                                SelectCommand="SELECT S.OrderID, S.Seq, S.MB001, I.MB002, I.MB003, I.MB004, S.FreeQty, S.Qty, S.UnitPrice, S.Discount, S.Qty*S.UnitPrice*S.Discount as Amount FROM Sales_Order_DTL S left join INVMB I on S.MB001=I.MB001 WHERE (S.OrderID = @OrderID)" 
                                UpdateCommand="UPDATE Sales_Order_DTL SET MB001 = @MB001, FreeQty = @FreeQty, Qty = @Qty, UnitPrice = @UnitPrice, Discount=@Discount, MODIFIER = @MODIFIER, MODI_DATE = @MODI_DATE WHERE (OrderID = @OrderID and Seq = @SEQM)"><SelectParameters><asp:Parameter Name="OrderID" /></SelectParameters><DeleteParameters><asp:Parameter Name="OrderID" /><asp:Parameter Name="SEQM" /></DeleteParameters><UpdateParameters><asp:Parameter Name="MB001" /><asp:Parameter Name="FreeQty" /><asp:Parameter Name="Qty" /><asp:Parameter Name="UnitPrice" /><asp:Parameter Name="Discount" /><asp:Parameter Name="MODIFIER" /><asp:Parameter Name="MODI_DATE" /><asp:Parameter Name="OrderID" /><asp:Parameter Name="SEQM" /></UpdateParameters><InsertParameters><asp:Parameter Name="OrderID" /><asp:Parameter Name="Seq" /><asp:Parameter Name="MB001" /><asp:Parameter Name="FreeQty" /><asp:Parameter Name="Qty" /><asp:Parameter Name="UnitPrice" /><asp:Parameter Name="Discount" /><asp:Parameter Name="CREATOR" /><asp:Parameter Name="CREATE_DATE" /></InsertParameters></asp:SqlDataSource><asp:HiddenField ID="_hfChildSearch" runat="server" /></ItemTemplate></asp:TemplateField>
                    ...
                    <asp:BoundField DataField="OrderID" HeaderText="單號" InsertVisible="False" 
                        ReadOnly="True" SortExpression="OrderID"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                    ...
                    <asp:BoundField DataField="Order_Date" HeaderText="銷貨日期" 
                    ...
                    <asp:BoundField DataField="Total" HeaderText="未稅銷貨金額" ReadOnly="True" SortExpression="Total"><ItemStyle HorizontalAlign="Right" /></asp:BoundField>
                    ...
                    <asp:BoundField DataField="Address" HeaderText="送貨地址" SortExpression="Address"><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                </Columns>
                    ...
                    <table style="width:50%;">
                        <tr>
                            ...
                            <td>
                                ...
                                onclick="window.open('../../Tools/Case.aspx?TextBoxId=BtbCaseNo', '','height=315,width=750,status=no,toolbar=no,menubar=no,location=no', '');"
                        ...
                        <tr>
                            <td>
                                <%=ResourceManager.GetString("SalesOrderPage_Lab_0_3")%>
                            </td>
                            <td>
                                <asp:TextBox ID="tbOrder_Date" runat="server" Height="21px" 
                                onclick="window.open('../../Tools/Calendar.aspx?TextBoxId=BtbOrder_Date', '','height=315,width=350,status=no,toolbar=no,menubar=no,location=no', '');"
                                    Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <%=ResourceManager.GetString("SalesOrderPage_Lab_0_9")%>
                            </td>
                            <td>
                                <asp:TextBox ID="tbAddress" runat="server" Height="21px" 
                                    Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
        ...
        <asp:SqlDataSource ID="dsMaster" runat="server"
            ConnectionString="<%$ ConnectionStrings:NorthWindCSConnectionString %>" 
            SelectCommand="SELECT S.*,C.MA002,B.CaseDescription FROM [Sales_Order] S left join [COPMA] C on S.MA001=C.MA001 left join [Basic_Case] B on S.CaseNo=B.CaseNo where (S.Company=@Company)" 
            DeleteCommand="DELETE FROM Sales_Order WHERE (OrderID = @OrderID)"                   
            UpdateCommand="UPDATE Sales_Order SET MA001 = @MA001, ORDER_DATE = @ORDER_DATE, CaseNo=@CaseNo, Department=@Department, TaxRate=@TaxRate, Total=@Total, Tax=@Tax, Address=@Address, Remark=@Remark, MODIFIER = @MODIFIER, MODI_DATE = @MODI_DATE where OrderID = @OrderID" 
            InsertCommand="INSERT INTO Sales_Order(OrderID, MA001, COMPANY, ORDER_DATE, CaseNo, Department, TaxRate, Total, Tax, Address, Remark, CREATOR, CREATE_DATE) VALUES (@OrderID, @MA001, @COMPANY, @ORDER_DATE, @CaseNo, @Department, @TaxRate, @Total, @Tax, @Address, @Remark, @CREATOR, @CREATE_DATE)">
            <DeleteParameters>
    ...
    <script type="text/javascript">
        ...
        function PrintOrder(mySelect) {
                ...
                sc = window.open('../../Report/Sales_OrderRPT.aspx?TextBoxId=' + mySelect, '', 'resizable=yes,scrollbars=yes,status=no,menubar=no,toolbar=no,location=no', '');
